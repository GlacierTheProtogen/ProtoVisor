CFLAGS=-Wall -Wextra -Wpedantic -Wshadow -g -Og -Wextra `pkg-config --cflags --libs libevdev`
...
LDFLAGS+=-L$(RGB_LIBDIR) -l$(RGB_LIBRARY_NAME) -lrt -g -lm -lpthread `pkg-config --cflags --libs libevdev`
